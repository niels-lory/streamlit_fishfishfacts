...
def classify(model_folder, image_input, image_dim):
    ...
    pred_1 = translate_class_index(class_index)
    pred_2,pred_3, pred_4 = find_maxima(predictions)
...
if uploaded_file:  # if user uploaded file
        ...
        pred_1, pred_2, pred_3, pred_4 = classify("models/230203_modelmaker_224px", img, image_dim=224)
